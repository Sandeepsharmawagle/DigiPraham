...
import { FaBrain, FaChartBar, FaCode, FaMobileAlt, FaGraduationCap, FaCheckCircle, FaRocket, FaShieldAlt, FaBullseye, FaHeadset } from 'react-icons/fa';
...
const services = [
  ...
  },
  {
    ...
    desc: 'Paid internships in AI, Data, Web & App — real projects, mentorship, and industry certificates.',
    slug: null,
    href: '/careers',
    color: '#A78BFA',
...
const whyUs = [
  { Icon: FaRocket, title: 'Fast Delivery', desc: 'Agile sprints with rapid iterations.', grad: '#7C6FFF' },
  { Icon: FaShieldAlt, title: 'Secure & Scalable', desc: 'Enterprise-grade architecture.', grad: '#FF6B9D' },
  { Icon: FaBullseye, title: 'Goal-Oriented', desc: 'Tied to measurable outcomes.', grad: '#43E97B' },
  { Icon: FaHeadset, title: '24/7 Support', desc: 'Dedicated post-launch support.', grad: '#FFB347' },
];
  ...
  return (
    <>
      ...
      <main>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'center' }}>
              ...
              <div>
                <HeroReveal delay={0.1} y={24} blur={8}>
                  <div className="badge" style={{ marginBottom: '2rem', display: 'inline-flex', alignItems: 'center', gap: '0.4rem' }}>
                    <HiSparkles style={{ color: '#7C6FFF' }} /> AI-First Digital Solutions
                  </div>
                </HeroReveal>
                <HeroReveal delay={0.25} y={40} blur={14} as="h1" className="display-1" style={{ marginBottom: '1.5rem', color: 'var(--text-main)' }}>
                  Build Smarter<br />
              ...
              <HeroReveal delay={0.4} y={50} blur={16} style={{ position: 'relative', display: 'flex', justifyContent: 'center' }}>
                <div style={{ position: 'relative', width: '100%', maxWidth: 520, aspectRatio: '4/3', borderRadius: 24, overflow: 'hidden', boxShadow: '0 32px 80px rgba(124,111,255,0.25)' }}>
                  <Image src="https://images.unsplash.com/photo-1555421689-d68471e189f2?w=1000&q=85" alt="Team collaborating on AI and technology solutions" fill style={{ objectFit: 'cover' }} priority />
        ...
        {/* ══ SERVICES GRID (now includes Internship) ════════════════════ */}
        <section className="section">
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
              ...
              <ScrollReveal text="Our Core Services" as="h2" className="section-title" style={{ marginBottom: '1.1rem', color: 'var(--text-main)' }} baseOpacity={0.05} enableBlur baseBlur={6} stagger={0.07} duration={0.75} />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(270px, 1fr))', gap: '1.5rem' }}>
              {services.map((svc) => {
                ...
                return (
                  <CardWrapper key={svc.title}>
                    <div
                      className="glass-card"
                      style={{ overflow: 'hidden', height: '100%', display: 'flex', flexDirection: 'column', transition: 'transform 0.3s, box-shadow 0.3s' }}
                      onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = `0 24px 64px ${svc.color}22`; }}
                    ...
                    >
                      <div style={{ position: 'relative', width: '100%', height: 180, flexShrink: 0 }}>
                        ...
                        <div style={{ position: 'absolute', top: 16, left: 16, width: 48, height: 48, borderRadius: 12, background: `${svc.color}25`, border: `1.5px solid ${svc.color}60`, backdropFilter: 'blur(8px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                          <svc.Icon size={22} style={{ color: svc.color }} />
                        </div>
                        {svc.href && (
                          <div style={{ position: 'absolute', top: 16, right: 16 }}>
                            <span className="badge" style={{ background: `${svc.color}25`, borderColor: `${svc.color}50`, color: svc.color, fontSize: '0.68rem' }}>🎓 New</span>
                          </div>
                        )}
                      </div>
                      <div style={{ padding: '1.75rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{ color: svc.color, fontSize: '0.85rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.3rem', fontFamily: 'Space Grotesk' }}>
                          {svc.href ? 'View Programs →' : 'Learn more →'}
                        </div>
                      </div>
                    </div>
                  </CardWrapper>
          ...
          <div className="container" style={{ position: 'relative', zIndex: 2 }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'center', marginBottom: '4rem' }}>
              <div style={{ position: 'relative', borderRadius: 20, overflow: 'hidden', aspectRatio: '16/10', boxShadow: '0 20px 60px rgba(0,0,0,0.4)' }}>
                <Image src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=900&q=80" alt="Agile team working together" fill style={{ objectFit: 'cover' }} />
              ...
              <div>
                ...
                <ScrollReveal text="Built for Results" as="h2" style={{ fontSize: 'clamp(2rem, 4vw, 3.25rem)', fontWeight: 800, letterSpacing: '-0.04em', color: '#fff', marginBottom: '1.25rem' }} baseOpacity={0.05} enableBlur baseBlur={8} stagger={0.08} duration={0.8} />
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                  {whyUs.map(w => (
                    <div key={w.title} className="dark-card" style={{ padding: '1.5rem' }}>
                      <div style={{ width: 44, height: 44, borderRadius: 12, background: `${w.grad}15`, border: `1.5px solid ${w.grad}40`, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '0.85rem' }}>
                        <w.Icon size={20} style={{ color: w.grad }} />
                      </div>
        ...
        <section className="section" style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="container" style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'center' }}>
              <div>
                <ScrollReveal as="div" style={{ marginBottom: '1.25rem' }}>
                  <div className="badge"><FaGraduationCap style={{ display: 'inline', marginRight: 6 }} />Internship Programs</div>
                </ScrollReveal>
                <ScrollReveal text="Launch Your Tech Career" as="h2" className="section-title" style={{ marginBottom: '1.1rem', color: 'var(--text-main)' }} baseOpacity={0.05} enableBlur stagger={0.07} />
                <ScrollReveal as="p" style={{ color: 'var(--text-muted)', lineHeight: 1.8, marginBottom: '2.25rem', fontSize: '1.025rem' }}>
                  Join our structured internship programs. Work on live projects, get certified, and build the portfolio that gets you hired.
                </ScrollReveal>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                {[
                  ...
                  <div key={p.duration} className="glass-card" style={{ padding: '1.75rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderColor: `${p.accent}25` }}>
                    <div style={{ flex: 1 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '0.6rem' }}>
                        <p.Icon size={18} style={{ color: p.accent }} />
                        <h4 style={{ fontWeight: 700, fontSize: '1rem', color: 'var(--text-main)' }}>{p.duration} Internship</h4>
                      ...
                      {p.features.map(f => (
                        <div key={f} style={{ fontSize: '0.82rem', color: 'var(--text-muted)', marginBottom: '0.25rem', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                          <FaCheckCircle size={11} style={{ color: p.accent, flexShrink: 0 }} /> {f}
                        </div>
                      ))}
                    </div>
                    <Link href="/careers" className="btn-primary" style={{ marginLeft: '1.5rem', padding: '0.55rem 1.25rem', fontSize: '0.82rem', background: `linear-gradient(135deg, ${p.accent}, ${p.accent}BB)`, flexShrink: 0 }}>Apply</Link>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="section" style={{ background: 'var(--bg-section)', borderTop: '1px solid var(--border-card)' }}>
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
              ...
              <ScrollReveal text="What Our Clients Say" as="h2" className="section-title" style={{ color: 'var(--text-main)' }} baseOpacity={0.05} enableBlur stagger={0.07} />
            </div>
        ...
        <section style={{ position: 'relative', padding: '8rem 0', textAlign: 'center', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', inset: 0 }}>
            <Image src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=1600&q=80" alt="Modern tech workspace" fill style={{ objectFit: 'cover', opacity: 0.15 }} />
          </div>
          ...
          <div className="container" style={{ position: 'relative', zIndex: 2 }}>
            <ScrollReveal text="Ready to Transform Your Business?" as="h2" style={{ fontSize: 'clamp(2.5rem, 6vw, 5rem)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.05, color: 'var(--text-main)', marginBottom: '1.5rem' }} baseOpacity={0.05} enableBlur baseBlur={10} stagger={0.06} duration={0.85} />
